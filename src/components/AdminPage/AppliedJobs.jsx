...
const AppliedJobs = () => {
  ...
  const fetchAllApplications = () => {
    setLoading(true);
    axios
      .get(`http://192.168.1.192:8080/mechyam/api/career/applications?page=${page}&size=${pageSize}`)
      .then((res) => {
  ...
  const handleSearch = () => {
    ...
    axios
      .get(`http://192.168.1.192:8080/mechyam/api/career/applications/job/${searchJobId}`)
      .then((res) => {
