        ...
        <ul className="hidden md:flex space-x-8 text-gray-800 font-medium">
          ...
          <li className="relative group">
            ...
            <div className="absolute left-0 mt-2 w-64 bg-white rounded-md shadow-lg opacity-0 group-hover:opacity-100 transform scale-95 group-hover:scale-100 transition-all duration-200 z-50">
              <ul className="py-2">
                <li><Link to="/engineering-design " className="block px-4 py-2 hover:bg-gray-100">Engineering Design</Link></li>
                <li><Link to="/structural-analysis " className="block px-4 py-2 hover:bg-gray-100">Structural Analysis</Link></li>
