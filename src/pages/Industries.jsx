      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          ...
          <div>
            ...
            <h2 className="text-xl font-bold text-blue-900 mb-2">Manufacturing & Plant Engineering</h2>
            <p className="text-gray-700 mb-4 text-justify">
            ...
            <Link to="/manufacturing-plantengineering" className="text-blue-700 font-semibold hover:underline">
              Read More
            </Link>
          </div>
          <div>
            <h1 className="text-6xl font-extrabold text-black">04</h1>
            <h2 className="text-xl font-bold text-blue-900 mb-2">Structural Systems and Infrastructure</h2>
            <p className="text-gray-700 mb-4 text-justify">
            ...
            <Link to="/structural-infrastructure" className="text-blue-700 font-semibold hover:underline">
              Read More
            </Link>
          </div>
          <div>
            <h1 className="text-6xl font-extrabold text-black">05</h1>
            <h2 className="text-xl font-bold text-blue-900 mb-2">Utilities & R&D Institutions</h2>
            <p className="text-gray-700 mb-4 text-justify">
            ...
            <Link to="/utilities-r&dinstutions" className="text-blue-700 font-semibold hover:underline">
              Read More
            </Link>
          </div>
        </div>
